...
int main( void)
{
    ...
    Shader *vertexShader = new Shader("shaders/plane3Dtangent.vs", ShaderType::VERTEX);
    Shader *fragmentShader = new Shader("shaders/plane3DtangentBloom.fs", ShaderType::FRAGMENT);
    Shader *quadVertex = new Shader("shaders/quad.vs", ShaderType::VERTEX);
    Shader *quadHDRFragment = new Shader("shaders/quadHDR.fs", ShaderType::FRAGMENT);
    Shader *sphereHDRFragment = new Shader("shaders/sphereTangentBloom.fs", ShaderType::FRAGMENT);
    Shader *guassianBlurFragment = new Shader("shaders/gaussianBlur.fs", ShaderType::FRAGMENT);
    ...
    Texture *diffuseTexture = new Texture("textures/bricks2.jpg", TextureType::DIFFUSE, GL_TEXTURE0);
    Texture *normalTexture = new Texture("textures/bricks2_normal.jpg", TextureType::NORMAL, GL_TEXTURE1);
    Texture *depthTexture = new Texture("textures/bricks2_disp.jpg", TextureType::DISPLACEMENT, GL_TEXTURE2);
